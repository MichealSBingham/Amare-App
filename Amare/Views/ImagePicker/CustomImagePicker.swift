...
extension View{
    ...
    */
    ...
    @ViewBuilder
        func cropImagePicker(options: [Crop], show: Binding<Bool>, originalImage: Binding<UIImage?>, croppedImage: Binding<UIImage?>) -> some View {
            CustomImagePicker(options: options, show: show, originalImage: originalImage, croppedImage: croppedImage) {
                self
            }
        }
